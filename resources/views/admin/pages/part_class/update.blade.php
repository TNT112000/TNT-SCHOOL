                ...
                <div class="col-12">
                    <div class="section" id="title-page">
                        <div class="title_update">
                            <h3 id="index" class="fl-left">Chỉnh sửa học phần</h3>
                    ...
                    <div class="section" id="detail-page">
                        <div class="section-detail">
                            <form method="POST" action="{{ route('part_class.update',['part_class'=>$part_class->id]) }}">
                                @csrf
                                @method('PUT')
                                <div class="row col-12 ">
                                    <div class="request_input col-4">
                                        ...
                                        <input type="text" name="code" id="title" class="with_input"
                                            value="{{ old('code') ? old('code') : $part_class->code }}" readonLy>
                                        @error('code')
                                    ...
                                    <div class="request_input col-4">
                                        ...
                                        value="{{ old('name') ? old('name') : $part_class->name }}">
                                        @error('name')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="request_input col-4">
                                        ...
                                        <select class="select_list" name="faculty_id" id="faculty_id">
                                            <option
                                                value="{{ old('faculty_id') ? old('faculty_id') : $part_class->faculty_id }}">
                                                {{ old('faculty_id') ? App\Models\Faculty::find(old('faculty_id'))->name : $part_class->faculty->name }}
                                            </option>
                                            @foreach ($faculty as $item)
                                                @if (old('faculty_id') ? $item->id != old('faculty_id') : $item->id != $part_class->faculty_id)
                                    ...
                                    <div class="request_input col-4">
                                        ...
                                        <select class="select_list" name="specialized_id" id="specialized_id">
                                            ...
                                            @else
                                                <option
                                                    value="{{ old('specialized_id') ? old('specialized_id') : $part_class->specialized_id }}">
                                                    {{ old('specialized_id') ? App\Models\Specialized::find(old('specialized_id'))->name : $part_class->specialized->name }}
                                                </option>
                                            @endif
                                    ...
                                    <div class="request_input col-4">
                                        ...
                                        <select class="select_list" name="classroom_id" id="classroom_id">
                                            ...
                                            @else
                                                <option
                                                    value="{{ old('classroom_id') ? old('classroom_id') : $part_class->classroom_id }}">
                                                    {{ old('classroom_id') ? App\Models\classroom::find(old('classroom_id'))->name : $part_class->classroom->name }}
                                                </option>
                                            @endif
                                        </select>
                                    ...
                                    <div class="request_input col-4">
                                        ...
                                        <select class="select_list" name="subject_id" id="subject_id">
                                            ...
                                            @else
                                                <option
                                                    value="{{ old('subject_id') ? old('subject_id') : $part_class->subject_id }}">
                                                    {{ old('subject_id') ? App\Models\subject::find(old('subject_id'))->name : $part_class->subject->name }}
                                                </option>
                                            @endif
                                        </select>
                                    ...
                                    <div class="request_input col-4">
                                        ...
                                        <select class="select_list" name="teacher_id" id="teacher_id">
                                            ...
                                            @else
                                                <option
                                                    value="{{ old('teacher_id') ? old('teacher_id') : $part_class->teacher_id }}">
                                                    {{ old('teacher_id') ? App\Models\teacher::find(old('teacher_id'))->name : $part_class->teacher->name }}
                                                </option>
                                            @endif
                                        </select>
                                        @error('teacher_id')
                                    ...
                                    <div class="request_input col-4">
                                        ...
                                        <input type="number" name="qty" class="d-block" value="{{ old('qty') ? old('qty') : $part_class->qty }}">
                                        @error('qty')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                </div>
                                <button type="submit" name="btn-submit" id="btn-submit" class="btn_submit">Cập nhập</button>
