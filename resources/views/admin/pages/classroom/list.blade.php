            ...
            <div id="content" class="fl-right display_flex">
                ...
                <div class="col-12">
                    ...
                    <div class="title_update width-300px">
                        <h3 id="index" class="fl-left">Danh sách lớp học</h3>
                                ...
                                <table id="myTable" class="table list-table-wp">
                                    <thead class="thead_color">
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="tfoot-text">Mã lớp học</span></td>
                                            <td><span class="tfoot-text">Tên lớp học</span></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="clearfix">
                                                        ...
                                                        <ul class="list-operation ">
                                                            <li><a href="{{ route('classroom.edit', ['classroom' => $item->id]) }}"
                                                                    title="Sửa" class="edit"><i class="fa fa-pencil"
                                                                        aria-hidden="true"></i></a>
                                                            </li>

                                                            <li><a href="{{ route('classroom.destroy', ['classroom' => $item->id]) }}"
