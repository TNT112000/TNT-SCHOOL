                        ...
                        <div class="section-detail">
                            <form method="POST" action="{{ route('faculty.update', ['faculty' => $faculty->id]) }}" >
                                ...
                                <div class="request_input">
                                    ...
                                    <input type="text" name="name" id="title" class="with_input"
                                        value="{{ old('name') ? old('name') : $faculty->name }}">
                            ...
                            <div class="display_flex box_btn">
                                <button type="submit" name="btn-submit" class="btn_submit" id="btn-submit">Cập
                                    nhập</button>
                                    <a href="{{route('faculty.destroy',['faculty'=>$faculty->id])}}" class="back_create delete_btn">Xóa</a>
                            </div>

                           

                                <a href="{{route('faculty.create')}}" class="back_create">Về thêm mới</a>
                        </form>
                    </div>
                </div>
            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="clearfix">
                                                    ...
                                                    <ul class="list-operation ">
                                                        <li><a href="{{ route('faculty.edit', ['faculty' => $item->id]) }}"
                                                                title="Sửa" class="edit"><i class="fa fa-pencil"
                                                                    aria-hidden="true"></i></a>
                                                        </li>

                                                        <li><a href="{{ route('faculty.destroy', ['faculty' => $item->id]) }}"
